 ...
 * @param {number} transfer_id - ID from the cars table, i.e., cars.id
 * @param {string} transfer_error - error.stack if error happens during transfer
 * @returns {Promise<void>}
 */
module.exports = async (scraperTable, scraperTable_car_id, transfered, transfer_id, transfer_error) => {
